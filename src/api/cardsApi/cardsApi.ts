...
export const cardsApi = {
    async getCards(cardsPack_id: string,pageNumber: number, pageSize: number, question?: string) {
        return await instance.get(`cards/card`, {params: {cardsPack_id, page: pageNumber, pageCount: pageSize, cardQuestion: (question && question)}})
    },
